...
async function categorySeeders() {
  const category = [
    {
      name: 'Completes',
      pictures: ['category-completes-home-picture.webp', 'category-completes-picture.webp'],
      description:
    ...
    {
      name: 'Decks',
      pictures: ['category-decks-home-picture.webp', 'category-decks-picture.webp'],
      description:
    ...
    {
      name: 'Trucks',
      pictures: ['category-trucks-home-picture.webp', 'category-trucks-picture.webp'],
      description:
    ...
    {
      name: 'Wheels',
      pictures: ['category-wheels-home-picture.webp', 'category-wheels-picture.webp'],
      description:
