...
async function decksSeeders() {
  ...
  const decks = [
    ...
    },
    {
      ...
      Art by Nate Reifke`,
      picture: [
        "strand_storm_deck_1.webp",
        "strand_storm_deck_2.webp",
        "strand_storm_deck_3.webp",
      ],
      price: 72.95,
      stock: 68,
      category: categoryId,
    ...
    },
    {
      ...
      picture: [
        "unagi_gorgon_deck_1.webp",
        "unagi_gorgon_deck_2.webp",
        "unagi_gorgon_deck_3.webp",
      ],
      price: 78.95,
      stock: 69,
      category: categoryId,
    ...
    },
    {
      ...
      Art by @elgrantokayo`,
      picture: [
        "jimmy_riha_pro_diver_deck_1.webp",
        "jimmy_riha_pro_diver_deck_2.webp",
        "jimmy_riha_pro_diver_deck_3.webp",
        "jimmy_riha_pro_diver_deck_5.webp",
      ],
      price: 68.95,
      stock: 81,
      category: categoryId,
    ...
    },
    {
      ...
      Art by Jor Ros`,
      picture: [
        "chop_hop_noh_deck_1.webp",
        "chop_hop_noh_deck_2.webp",
        "chop_hop_noh_deck_3.webp",
      ],
      price: 71.95,
      stock: 58,
      category: categoryId,
  ...
  for (const product of decks) {
    ...
    await category.save();
    console.log("categoría actualizada (Decks)");
  }
}
